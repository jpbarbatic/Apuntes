...
- **Usa listas blancas** si necesitas inclusión dinámica:
  ```php
  // ✅ Seguro
...
> 💡 Si incluyes un archivo con funciones dos veces con `include`, PHP dará error:  
