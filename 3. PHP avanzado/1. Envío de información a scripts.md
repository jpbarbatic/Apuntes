# Envío de información a scripts
...
Los parámtros se colocan después de la URL, colocando el símbolo **?**, y a continuación los parámetros y los valores, separados por el símbolo **&**.
